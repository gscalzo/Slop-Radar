#!/usr/bin/env node
/*
 * Builds the evaluation corpus in eval/local (gitignored — other people's
 * writing does not belong in this repo).
 *
 ...
 *
 * AI samples are generated by the model you configure, which is the honest
 * positive class: it is what people actually paste into the feed.
 *
 * Every file gets an entry in eval/local/manifest.json with its source URL,
